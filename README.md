...
PoC Assets panel では、現在の workspace / playbook / connector 設定から README、proposal section、follow-up email、Mermaid architecture diagram、SQL、Python、Terraform、checklist の starter template を生成できます。生成物は preview と clipboard export のみで、OCI API、DB 接続、Terraform apply は実行しません。
